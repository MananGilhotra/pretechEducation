...
const { createAdmission, createAdmissionAdmin, getAdmissions, getAdmissionById, getMyAdmission, approveAdmission, exportAdmissions, deleteAdmission, updateAdmission, searchAdmissionsLite } = require('../controllers/admissionController');
...
router.get('/search', protect, authorize('admin'), searchAdmissionsLite);
